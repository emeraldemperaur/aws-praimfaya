                    ...
                    <li>
                        ...
                        <ul role="menu">
                            ...
                            <NavLink className="ux-dropdown-link" style={dropLinkStyle} to="dashboard" onClick={() => closeDropDowns()}>
                                ...
                                <p>Visualize overall RAG pipeline system performance</p>
                                </div>
                            </NavLink>
                            </li>
                            <li role="menuitem">
                            <NavLink className="ux-dropdown-link" style={dropLinkStyle} to="/dashboard/usage-watchtower" onClick={() => closeDropDowns()}>
                                <img style={{width: '40px', height: '40px'}} src={analyticsIcon} className="icon" alt="AI Chip" />
                                <div>
                                <span className="ux-dropdown-link-title" style={titleStyle}>Usage Watchtower</span>
                                <p>Track agentic tool usage and compute costs</p>
                                </div>
                            </NavLink>
                            </li>
                            <li role="menuitem">
                            <NavLink className="ux-dropdown-link" style={dropLinkStyle} to="/dashboard/agents-activity" onClick={() => closeDropDowns()}>
                                <img style={{width: '40px', height: '40px'}} src={cpuIcon} className="icon" alt="CPU" />
                                <div>
                                <span className="ux-dropdown-link-title" style={titleStyle}>Agents Activity</span>
                                <p>Monitor performance metrics of active agents</p>
                                </div>
                            </NavLink>
                            </li>
                            <li role="menuitem">
                            <NavLink className="ux-dropdown-link" style={dropLinkStyle} to="/dashboard/rag-artifacts" onClick={() => closeDropDowns()}>
                                ...
                                <p>Access artifacts generated by RAG sessions</p>
                                </div>
                            </NavLink>
                            </li>
                        </ul>
